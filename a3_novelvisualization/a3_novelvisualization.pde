...
void draw() {
  ...
  String[] lines = loadStrings("uniquewords.txt");  //gets each line from uniquewords.txt
   for (int i = 0; i < 60; i++)  //loop through however many times, in our case 60 to fill up the screen, can change as needed
   {
